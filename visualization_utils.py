...
#==================================================================================#    
  with open('PASCALVOC/detections/' + txt_name, 'w') as txt_file:
    ...
    for box, color in box_to_color_map.items():
      ...
      class_name = category_index[classes[t]]['name']
      
      txt_file.write(str(class_name) + ' ' + str(scores[t]) + ' ' +
                     str(new_xmin) + ' ' + str(new_ymin) + ' ' +
                     str(new_xmax) + ' ' + str(new_ymax) + '\n')
